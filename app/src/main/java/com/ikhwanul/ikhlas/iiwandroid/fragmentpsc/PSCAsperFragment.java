...
public class PSCAsperFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener{
    ...
    public PSCAsperFragment() {
        super();
        this.res_layout = R.layout.fragment_perwakilan;
    }

    public static PSCAsperFragment newInstance() {
        PSCAsperFragment fragment = new PSCAsperFragment();
        return fragment;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getPSCAsper(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    }
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getPSCAsper(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
