...
public class BinaanMMAdapter extends
        RecyclerView.Adapter<BinaanMMAdapter.MyViewHolder> {
    ...
    public BinaanMMAdapter(Context context, List<BinaanKDM_MM> binaanList) {
