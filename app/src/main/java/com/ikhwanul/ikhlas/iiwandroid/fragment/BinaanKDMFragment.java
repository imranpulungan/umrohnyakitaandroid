...
public class BinaanKDMFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener{

    private OnFragmentInteractionListener mListener;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private RecyclerView rvBinaanKDM;
    private SearchView svData;
    private BinaanKDMAdapter mAdapter;
    ...
    public BinaanKDMFragment() {
        super();
        this.res_layout = R.layout.fragment_binaan_kdm;
    }

    public static BinaanKDMFragment newInstance() {
        BinaanKDMFragment fragment = new BinaanKDMFragment();
        return fragment;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getBinaanKDM(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    }
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getBinaanKDM(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
    ...
    public void doSuccess(ApiResponse response, String tag) {
        if (tag.equals(Presenter.RES_GET_DATA_BINAAN_KDM)){
            ...
            if (dataBinaan.size() > 0){
                mAdapter = new BinaanKDMAdapter(getContext(), dataBinaan);
