...
import com.ikhwanul.ikhlas.iiwandroid.adapterpsc.PSCHistoryBuyAdapter;
...
public class PSCKwitansiBuyStokFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener{

    private OnFragmentInteractionListener mListener;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private RecyclerView rvDataPerwakilan;
    private SearchView svData;
    private PSCHistoryBuyAdapter mAdapter;
    private Presenter mPresenter;
    private List<PSCDataHistoryStok> dataPerwakilanPSC;
    ...
    public PSCKwitansiBuyStokFragment() {
        super();
        this.res_layout = R.layout.fragment_perwakilan;
    }

    public static PSCKwitansiBuyStokFragment newInstance() {
        PSCKwitansiBuyStokFragment fragment = new PSCKwitansiBuyStokFragment();
        return fragment;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getHistoryBuyStok(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    }
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getHistoryBuyStok(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
    ...
    public void doSuccess(ApiResponse response, String tag) {
        if (tag.equals(Presenter.RES_GET_DATA_BINAAN_KDM)){
            dataPerwakilanPSC = ((PSCDataHistoryStokResponse)response).data;
            if (dataPerwakilanPSC.size() > 0){
                mAdapter = new PSCHistoryBuyAdapter(getContext(), dataPerwakilanPSC);
