...
public class PSCKwitansiPerwakilanFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener{
    ...
    public PSCKwitansiPerwakilanFragment() {
        super();
        this.res_layout = R.layout.fragment_perwakilan;
    }

    public static PSCKwitansiPerwakilanFragment newInstance() {
        PSCKwitansiPerwakilanFragment fragment = new PSCKwitansiPerwakilanFragment();
        return fragment;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getPSCKwitansiPerwakilan(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    }
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getPSCKwitansiPerwakilan(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
