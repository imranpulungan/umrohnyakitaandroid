...
public class ProgressDialogHolder {
    public static ProgressDialogHolder self;
    ...
    public static ProgressDialogHolder with(Context context){
        if (self != null && self.mContext == context)
            return  self;

        return (self = new ProgressDialogHolder(context));
    }
}
