...
public class KomisiKDMFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener {
    ...
    public KomisiKDMFragment() {
        super();
        this.res_layout = R.layout.fragment_komisi_kdm;
    }

    public static KomisiKDMFragment newInstance() {
        KomisiKDMFragment fragment = new KomisiKDMFragment();
        return fragment;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getKomisiKDM(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getKomisiKDM(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
