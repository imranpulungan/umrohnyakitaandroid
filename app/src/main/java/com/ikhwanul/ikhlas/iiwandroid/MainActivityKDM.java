...
public class MainActivityKDM extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_kdm);
        ...
        navigationView = (NavigationView) findViewById(R.id.nav_view_kdm);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            m.findItem(R.id.nav_commission_kdm).setVisible(b);
        ...
        }else if (id == R.id.nav_share_kdm) {
            setTitle("Grup Binaan KDM");
            fragmentContent = BinaanKDMFragment.newInstance();
        ...
        }else if(id == R.id.nav_commission_kdm){
            setTitle("Komisi KDM");
            fragmentContent = KomisiKDMFragment.newInstance();
                ...
                builder.setPositiveButton("OK",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Session.with(MainActivityKDM.this).clearLoginSession();
                            }
                        });
