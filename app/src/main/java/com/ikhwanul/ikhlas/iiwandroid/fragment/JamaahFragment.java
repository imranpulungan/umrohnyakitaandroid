...
public class JamaahFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener {
    ...
    public JamaahFragment() {
        super();
        this.res_layout = R.layout.fragment_jamaah;
    }

    public static JamaahFragment newInstance() {
        JamaahFragment fragment = new JamaahFragment();
        return fragment;
    }
