...
public class RewardFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener{
    ...
    private List<Reward> dataReward;
    ...
    public RewardFragment() {
        super();
        this.res_layout = R.layout.fragment_reward;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getReward(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    }
    ...
    protected void initView(){
        ...
        rvReward = (RecyclerView) findViewById(R.id.rv_reward);
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getReward(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
    ...
    public void doSuccess(ApiResponse response, String tag) {
        if (tag.equals(Presenter.RES_GET_DATA_REWARD)){
            if (!response.error){
                dataReward = ((RewardResponse)response).reward;
                if (dataReward.size() > 0){
                    mAdapter = new RewardAdapter(getContext(), dataReward);
                    rvReward.setLayoutManager(new GridLayoutManager(getContext(), 1));
