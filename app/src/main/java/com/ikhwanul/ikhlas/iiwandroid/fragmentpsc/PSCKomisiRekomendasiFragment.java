...
import com.ikhwanul.ikhlas.iiwandroid.adapterpsc.PSCDataKomisiRekomendasiAdapter;
...
public class PSCKomisiRekomendasiFragment extends AppFragment implements iPresenterResponse, SearchView.OnQueryTextListener{

    private OnFragmentInteractionListener mListener;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private RecyclerView rvDataPerwakilan;
    private SearchView svData;
    private PSCDataKomisiRekomendasiAdapter mAdapter;
    private Presenter mPresenter;
    private List<PSCDataKomisiRekomendasi> dataPerwakilanPSC;
    ...
    public PSCKomisiRekomendasiFragment() {
        super();
        this.res_layout = R.layout.fragment_perwakilan;
    }

    public static PSCKomisiRekomendasiFragment newInstance() {
        PSCKomisiRekomendasiFragment fragment = new PSCKomisiRekomendasiFragment();
        return fragment;
    }
    ...
    private void initObject() {
        ...
        mPresenter.getKomisiRekomendasi(Integer.valueOf(dataUser.id_perwakilan), progressDialog, true);
    }
    ...
    private void initEvent(){
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.getKomisiRekomendasi(Integer.valueOf(dataUser.id_perwakilan), progressDialog, false);
            }
        });
    }
    ...
    public void doSuccess(ApiResponse response, String tag) {
        if (tag.equals(Presenter.RES_GET_DATA_BINAAN_KDM)){
            dataPerwakilanPSC = ((PSCKomisiRekomendasiResponse)response).data;
            if (dataPerwakilanPSC.size() > 0){
                mAdapter = new PSCDataKomisiRekomendasiAdapter(getContext(), dataPerwakilanPSC);
